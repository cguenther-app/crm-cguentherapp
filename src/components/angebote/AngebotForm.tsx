...
import { Offer, OFFER_STATUS, OFFER_STATUS_LABELS, Product } from '@/types'
...
const schema = z.object({
  ...
  number: z.string().min(1, 'Angebotsnummer ist erforderlich'),
...
export type AngebotFormData = z.infer<typeof schema>

interface Props {
  initialData?: Partial<Offer>
  onSubmit: (data: AngebotFormData) => Promise<void>
  submitLabel?: string
}

export function AngebotForm({ initialData, onSubmit, submitLabel = 'Speichern' }: Props) {
